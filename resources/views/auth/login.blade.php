...
<head>
    ...
    <meta name="description"
        content="Learnity adalah aplikasi yang membantu dunia perkuliahan mahasiswa mulai dari mengorganisasi pelajaran, tugas dan jadwal.">
    <meta name="keywords" content="Learnity, UMKT, Aplikasi Perkuliahan">
    <meta name="author" content="UMKT">
    ...
    <title>Masuk Aplikasi - Learnity</title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7">
                <img class="bg-img-cover bg-center" src="{{url('cuba/assets/images/login/UMKT.jpg')}}"
                    alt="looginpage">
            </div>
