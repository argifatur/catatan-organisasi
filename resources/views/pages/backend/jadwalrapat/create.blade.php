...
@section('title', 'Atur Jadwal Rapat — Catatan Organisasi')
@section('content')
...
<div class="container-fluid">
    ...
    <div class="page-title">
        <div class="card card-absolute mt-5 mt-md-4">
            ...
            <div class="card-body">
                <p>
                    Dibawah ini adalah form untuk tambah jadwal rapat.
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Atur Jadwal Rapat</h5>
                </div>
                <form method="POST" action="{{route('jadwal-rapat.store')}}" enctype="multipart/form-data"
                            ...
                            <div class="form-group col-md-12 mb-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="judul_rapat" type="text" class="form-control"
                                        value="{{old('judul_rapat')}}" name="judul_rapat" required>
                                </div>
                            </div>
                            <div class="form-group col-md-12 mb-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="agenda_rapat" type="text" class="form-control"
                                        value="{{old('agenda_rapat')}}" name="agenda_rapat" required>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 mb-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input required id="kelas" type="text" value="{{old('tempat')}}" class="form-control"
                                        name="tempat">
                                </div>
                            </div>
                        </div>
