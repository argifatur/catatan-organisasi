...
@section('title', 'Edit Bookmarks Baru — Learnity')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute mt-5 mt-md-4">
                <div class="card-header bg-primary">
                    <h5 class="text-white">🔖🌏 • Edit Bookmarks Baru</h5>
                </div>
                <div class="card-body">
                    <p>
                        Dibawah ini adalah halaman untuk Edit bookmarksmu. <span class="d-none d-md-inline">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        ...
                        @endif
                        <form class="row" method="POST" action="{{route('bookmarks.update', $bookmark->id)}}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" id="judul" name="judul" type="text" required="" value="{{$bookmark->judul}}">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" id="url" name="url" value="{{$bookmark->url}}"
                                                type="text" required="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="theme-form">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="deskripsi"
                                                id="exampleFormControlTextarea1" maxlength="255" rows="3">{{$bookmark->deskripsi}}</textarea>
                                        </div>
                                    </div>
                                </div>
