...
@section('title', 'Bookmarks — Learnity')
@section('content')
                ...
                <div class="card-body">
                    <p>
                        Dibawah ini adalah kumpulan link bookmarks yang telah kamu tambahkan. <span
                            ...
                            tambah
                            bookmarks
                            <a href="{{route('bookmarks.create')}}">disini ⇾</a>
                        </span>
                    </p>
                </div>
            </div>
                            ...
                            <div class="media">
                                <div class="media-body">
                                    <h6 class="f-w-600"><a href="{{$item->url}}">{{$item->judul}}</a>
                                        ...
                                        <form action="{{route('bookmarks.edit', $item->id)}}"
                                            class="d-inline">
                                           <button
                                                class="badge badge-warning pull-right">Edit</button>
                                        </form>
