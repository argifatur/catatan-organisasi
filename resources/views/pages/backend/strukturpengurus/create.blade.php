...
@section('title', 'Atur Struktur Pengurus — Catatan Organisasi')
@section('content')
    ...
    <div class="page-title">
        <div class="card card-absolute mt-5 mt-md-4">
            <div class="card-header bg-primary">
                <h5 class="text-white">
                    📅📚 • Atur Struktur Pengurus
                </h5>
            </div>
            <div class="card-body">
                <p>
                    Dibawah ini adalah form untuk tambah Struktur Pengurus.
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5>Atur Struktur Pengurus</h5>
                </div>
                <form method="POST" action="{{route('struktur-pengurus.store')}}" enctype="multipart/form-data"
                            ...
                            <div class="form-group col-md-12 mb-2">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="jabatan" type="text" class="form-control"
                                        value="{{old('jabatan')}}" name="jabatan" required>
                                </div>
                            </div>
                            <div class="form-group col-md-12 mb-2">
